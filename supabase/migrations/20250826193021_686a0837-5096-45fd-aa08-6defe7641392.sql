...
DROP FUNCTION IF EXISTS public.notify_project_planning_correction();
...
declare
  ...
  v_headers jsonb := jsonb_build_object('Content-Type','application/json', 'Authorization', 'Bearer ' || current_setting('app.settings.service_role_key', true));
