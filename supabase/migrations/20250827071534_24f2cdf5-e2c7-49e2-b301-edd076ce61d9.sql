...
-- Create a table to track sent emails and prevent duplicates
...
ADD CONSTRAINT unique_planning_correction_notification 
UNIQUE (project_id, notification_type, project_status, correction_reason);
...
CREATE POLICY "Admin can view all email notifications" ON public.email_notifications
