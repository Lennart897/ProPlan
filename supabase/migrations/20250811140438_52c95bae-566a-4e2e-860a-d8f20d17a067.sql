...
CREATE TABLE IF NOT EXISTS public.project_location_approvals (
...
CREATE POLICY IF NOT EXISTS "Users can view approvals for projects they can see"
...
CREATE POLICY IF NOT EXISTS "Supply Chain can create approvals"
ON public.project_location_approvals
FOR INSERT
TO authenticated
WITH CHECK (
...
CREATE POLICY IF NOT EXISTS "Planning can approve for their location"
ON public.project_location_approvals
FOR UPDATE
TO authenticated
USING (
...
-- updated_at trigger
CREATE TRIGGER IF NOT EXISTS update_project_location_approvals_updated_at
...
CREATE TRIGGER IF NOT EXISTS t_after_change_refresh_status
...
CREATE TRIGGER IF NOT EXISTS t_on_project_status_to_in_progress
