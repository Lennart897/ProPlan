-- Fix the URL in the planning correction trigger to match the working correction trigger
...
AS $function$
declare
  -- FIX: Use the correct URL structure like the working correction trigger
...
begin
  ...
  -- Send email to SupplyChain when status changes from 4 to 3 ONLY (planning correction)
